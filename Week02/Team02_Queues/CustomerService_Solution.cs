...
/// </summary>
public class CustomerService_Solution
{
    public static void Run()
    {
        ...
        var service = new CustomerService_Solution(4);
        ...
        service = new CustomerService_Solution(4);
        service.AddNewCustomer();
        service.AddNewCustomer();
        ...
        service = new CustomerService_Solution(0);
    ...
    public CustomerService_Solution(int maxSize)
    {
        if (maxSize <= 0)
            _maxSize = 10;
        else
